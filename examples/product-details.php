...
<body class="product-page">
	<nav class="navbar navbar-rose navbar-transparent navbar-fixed-top navbar-color-on-scroll" color-on-scroll="100">Header</nav>
	<div class="page-header header-filter" data-parallax="true" filter-color="rose" style="background-image: url('../assets/img/bg6.jpg');">
	    <div class="container">
	        <div class="row title-row">
				...
				<a href="https://shoes-ngoctran1910.c9users.io/hangxachtay/examples/view-cart.php" class="cart-box" id="cart-info" title="View Cart">
...
$results=$conn->query("SELECT TenSP, Mota, Gia FROM sanpham WHERE idSP=$idSP LIMIT 1");
if(!$results){
	printf("Error: %s\n", $conn->error);
	exit;
}
            ...
            <div class="main main-raised main-product">
                <div class="row">
					...
					<form method="POST" action="cart_process.php" class="form-item">
						<div class="col-md-6 col-sm-6">
						<h2 class="title"> <?php echo $row["TenSP"]; ?> </h2>
						<h3 class="main-price">$<?php echo $row["Gia"]; ?></h3>
						<div id="acordeon">
